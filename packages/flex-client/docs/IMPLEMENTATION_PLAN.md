...
14. CI publish workflow with DateVer versioning for npmjs
15. Agent ecosystem adapters (`flex-tools-core`)
...
- [x] Phase 14: CI npmjs publishing with DateVer
- [x] Phase 15: reusable tool-core adapter package
